"""
v2: Add text and more spacing within a paragraph
"""
import socket
...
def main(opts):
    ...
    def create_dataset():
        ...
        if opts.renderer == "saved":
            ...
            daemon_iterator = WordImgIterator(render_text_pair_gen, buffer_size=opts.daemon_buffer_size)
...
def display_output(ocr_dataset):
        ...
        draw_gt_layout(image_path, opts.coco_path, format="COCO", draw_boxes=True, draw_segmentations=False
                       , save_path=coco_box)
        draw_gt_layout(image_path, opts.coco_path, format="COCO", draw_boxes=False, draw_segmentations=True, save_path=coco_seg)
